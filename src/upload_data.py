...
def upload_data(args):
    ...
    try:
        ...
        s3_client.upload_file(args.input_file_path, bucket_name,args.output_file_path)
        logger.info("Uploaded the file from " + args.input_file_path + " to " + bucket_name + " as " + args.output_file_path)
